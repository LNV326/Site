...
<div class='row'>
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id='menu-header'>
		<div class="navbar navbar-inverse navbar-fixed-top hidden-md hidden-lg">
			<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#panel-left">
				<span class="icon-bar"></span>
				<span class="icon-bar"></span>
				<span class="icon-bar"></span>
			</button>
			<a class="navbar-brand" href="#"><? echo $nfs->unconvert_html($page[title]); ?></a>
		</div>
	</div>
</div>

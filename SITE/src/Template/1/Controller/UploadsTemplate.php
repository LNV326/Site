...
<script language='javascript'>
		...
		<br>
			<form enctype='multipart/form-data' method='post' action='index.php?page=uploads&load=go' style='margin:0pt' name='LoadForm'>
			<table align=center cellspacing=1 cellpadding=1 style='border:1px solid #555555;width:98%;margin-top:5pt'>
			<tr bgcolor='#424242'><td colspan=2><p align=center>Загрузка файлов:</p></td></tr>
			<tr bgcolor='#212121'><td colspan=2><p style='font-size:3pt'>&nbsp;</p></td></tr>
			<tr bgcolor='#323232'><td colspan=2><p align=normal>Допустимые для загрузки расширения файлов: <b>
			<?php foreach ($out['exts'] as $ext) {
				echo $ext." ";
			}?>
			<br></b>Максимальный размер загружаемого файла: <b><?php echo round((( $max_file_size / 1024 ) / 1024) , 2);?>MB"
			</b></p></td></tr>
			<tr bgcolor='#212121'><td colspan=2><p style='font-size:3pt'>&nbsp;</p></td></tr>
			<tr bgcolor='#424242'><td colspan=2><p align=center>Тип файла:</p></td></tr>
			<tr bgcolor='#212121'><td colspan=2><p style='font-size:3pt'>&nbsp;</p></td></tr>
			<tr bgcolor='#313131'><td width=90%><p>Выберете тип загрузки файла! Какой тип выбрать читайте в правилах!</p></td>
			<td align=right width=10%><select name='types' onChange='show_settings()' class='forminput'>
			<option value='1'>Файл с рисунком</option>
			<option value='2'>Файл без рисунка</option>
			</select></td></tr>
			<tr bgcolor='#212121'><td colspan=2><p style='font-size:3pt'>&nbsp;</p></td></tr>
			<tr bgcolor='#424242'><td colspan=2><p align=center>Выберете файл для загрузки:</p></td></tr>
			<tr bgcolor='#212121'><td colspan=2><p style='font-size:3pt'>&nbsp;</p></td></tr>
			<tr bgcolor='#323232'><td colspan=2><p>Соблюдение правил в ваших-же интересах! Чтобы файл появился хотите вы а не мы!</p></td></tr>
			<tr bgcolor='#212121'><td colspan=2><p style='font-size:3pt'>&nbsp;</p></td></tr>
			<tr bgcolor='#323232'><td colspan=2>
		...
		<div id='new_items'><p class=normal>Скриншот (800х600):<br><input type='file' name='file[]' class=textinput size='35'></p></div>
			...
			<tr bgcolor='#212121'><td colspan=2><p style='font-size:3pt'>&nbsp;</p></td></tr>
			<tr bgcolor='#313131'><td colspan=2><p align=center><input name='Button' class=forminput type='button' value='Назад' onClick='javascript:history.go(-1)'> <input type='submit' class='forminput' name='LoadGo' value='Загрузить файлы'></p></td></tr>
			</table>\n</form>
<?php }?>
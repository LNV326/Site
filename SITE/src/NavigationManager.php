...
abstract class NavigationManager {
	...
	public static function getMainMenu() {
		...
		//Элементы меню
		$main_menu=array();
		$main_menu[] = array("ru" => "Новости сайта", "en" => "Site News", "url" => "/", "image" => "rss.png", "image_title" => "RSS News", "image_link" => "http://www.".self::$_conf[site_url]."/modules/rss.php");
		$main_menu[] = array("ru" => "Форум сайта", "en" => "Forum", "url" => "/forum/");//, "image" => "wap.png", "image_link" => "http://wap.nfsko.ru", "image_title" => "Wap Forum", "noindex" => true);
		$main_menu[] = array("ru" => "Чат сайта (".$count.")", "en" => "Chat (".$count.")", "url" => "/chat/", "blank" => "1");
		$main_menu[] = array("ru" => "Файловый архив", "en" => "Files", "url" => "http://files.nfsko.ru", "noindex" => true);
		$main_menu[] = array("ru" => "Галерея сайта", "en" =>"Gallery", "url"=> "http://images.nfsko.ru", "noindex" => true);
		$main_menu[] = array("ru" => "Вопросы и ответы", "en" => "FAQ", "url" => "/index.php?page=faq" );
		$main_menu[] = array("ru" => "Поиск по сайту", "en"	=> "Search", "url"	=> "/index.php?page=search" );
		//$main_menu[] = array("ru" => "Статистика сайта", "en" => "Statistics", "url" => "/index.php?page=stat" );
		$main_menu[] = array("ru" => "Ссылки на сайты", "en" => "Links", "url"	=> "/index.php?page=links" );
